...
data class Contract constructor(@JsonProperty("text") val text: String ,@JsonProperty("owner") val owner: PublicKey,@JsonProperty("intendedRecipient") val intendedRecipient: PublicKey) : BlockData {
